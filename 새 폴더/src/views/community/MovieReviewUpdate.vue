<template>
  <div class="container text-center" style="width:50% ;margin-top : 10%">
    ...
    <div id="movie-title-container">
      <input class="text-left btn btn-secondary" type="text" style="width:100%" id="movieTitleInput" :placeholder="[[ MovieReview.movie_title ]]" autocomplete="off" @keyup="showSuggestion">
    </div>
    ...
    <div style="font-size : 1.5rem" id="star-rank">
      <span class="mx-1" @click="starClick(1)" @mouseover="fillStar(1)" @mouseout="clearStar" id="star-1">★</span>
      <span class="mx-1" @click="starClick(2)" @mouseover="fillStar(2)" @mouseout="clearStar" id="star-2">★</span>
      <span class="mx-1" @click="starClick(3)" @mouseover="fillStar(3)" @mouseout="clearStar" id="star-3">★</span>
      <span class="mx-1" @click="starClick(4)" @mouseover="fillStar(4)" @mouseout="clearStar" id="star-4">★</span>
      <span class="mx-1" @click="starClick(5)" @mouseover="fillStar(5)" @mouseout="clearStar" id="star-5">★</span>
    </div>
    <button class="btn btn-secondary my-3" @click="onPost">update your review</button>
  </div>
</template>
<script>
...
export default {
  data : function () {
    return {
      MovieReview : {
        rank : this.$route.params.review.rank,
        content : this.$route.params.review.content,
        movie_title : this.$route.params.review.movie_title,
        title : this.$route.params.review.title,
        username : this.$route.params.review.username,
      },
      starStatus : false,
      movies : movies,
      first : this.$route.params.review.movie_title,
  ...
  methods : {
    ...
    onPost : function () {
      ...
      axios.put(`${SERVER_URL}/community/movie_review_update_delete/${this.$route.params.review.id}/`,this.MovieReview,config)
      .then(()=>{
